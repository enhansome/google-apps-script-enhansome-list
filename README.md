...
* [googleworkspace/apps-script-samples](https://github.com/googleworkspace/apps-script-samples) ⭐ 5,239 | 🐛 121 | 🌐 JavaScript | 📅 2026-07-30 Various sample code and projects for the Google Apps Script platform
...
* [google/clasp](https://github.com/google/clasp) ⭐ 5,836 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-28 Develop Apps Script projects locally using clasp (Command Line Apps Script Projects) CLI
* [gas-github](https://github.com/leonhartX/gas-github) ⭐ 4,528 | 🐛 51 | 🌐 JavaScript | 📅 2025-03-12 Chrome-extension to manage Google Apps Script(GAS) code with github/github enterprise
...
* [brucemcpherson/gas-fakes](https://github.com/brucemcpherson/gas-fakes) ⭐ 79 | 🐛 57 | 🌐 JavaScript | 📅 2026-09-16 A proof of concept implementation of Apps Script environment on node.js
...
* [apps-script-starter](https://github.com/labnol/apps-script-starter) ⭐ 1,254 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-14 A starter kit for building Google Apps Script projects with modern JavaScript ES6, Webpack, Babel and ESLint inside Visual Studio Code
...
* [MaksymStoianov/appsscript-boot](https://github.com/MaksymStoianov/appsscript-boot) ⭐ 26 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-13 A framework for Google Apps Script that simplifies API creation, route management, and maintains a clean project architecture.
...
* [appsscript-utils](https://github.com/MaksymStoianov/appsscript-utils) ⭐ 29 | 🐛 232 | 🌐 TypeScript | 📅 2026-09-21 A collection of reusable utilities and helpers for Google Apps Script development, written in TypeScript
...
* [scriptit-fr/GenAIApp](https://github.com/scriptit-fr/GenAIApp) ⭐ 28 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-22 Google Apps Script binding for Gemini and OpenAI generative AI APIs

### Parsing

* [cheeriogs](https://github.com/tani/cheeriogs) ⭐ 493 | 🐛 6 | 🌐 JavaScript | 📅 2024-08-17 HTML manipulation library with jQuery-like interface
...
* [apps-script-oauth2](https://github.com/gsuitedevs/apps-script-oauth2) ⭐ 1,749 | 🐛 47 | 🌐 JavaScript | 📅 2026-06-16 An OAuth2 library for Google Apps Script
...
* [Gmail Unsubscriber](https://github.com/labnol/unsubscribe-gmail) ⭐ 1,566 | 🐛 0 | 🌐 JavaScript | 📅 2025-04-04 Google Script for unsubscribing from emails newsletters and other bulk email in Gmail with one click.
...
* [Viber/build-a-bot-with-zero-coding](https://github.com/Viber/build-a-bot-with-zero-coding) ⭐ 485 | 🐛 14 | 🌐 JavaScript | 📅 2022-03-21 An example of using Google Sheets to create a Viber survey chat bot without a backend server
...
* [artofthesmart/QUnitGS2](https://github.com/artofthesmart/QUnitGS2) ⭐ 28 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-14 A Google Apps Script library that brings the power and simplicity of QUnit unit testing to your scripts and applications. In just 60 seconds you can add unit testing to any script.
...
* [Collection of Apps Scripts for connecting to APIs](https://github.com/benlcollins/apps_script_apis) ⭐ 195 | 🐛 2 | 🌐 JavaScript | 📅 2022-07-28
...
* [Gmail2GDrive](https://github.com/ahochsteger/gmail-processor/tree/1.x) ⭐ 587 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-22  Automatically stores and sorts Gmail attachments into Google Drive folders - replaced by [Gmail Processor](https://ahochsteger.github.io/gmail-processor/)
...
* [JSONPath](https://script.google.com/a/google.com/d/1BtmcVnmTKAxqdiHN9Q5cM6M6E5MUMzVtQjSfav-OIQxNIoACkDdlst53/edit) Extract data from complex data structures with simple expressions. Google Apps Script version of [this](https://github.com/dchester/jsonpath) ⭐ 1,429 | 🐛 106 | 🌐 JavaScript | 📅 2026-03-05 library.
...
* [googlesamples/apps-script](https://github.com/googlesamples/apps-script) ⭐ 5,239 | 🐛 121 | 🌐 JavaScript | 📅 2026-07-30 Sample code for Google Apps Script, a cloud-based scripting service for Google Apps

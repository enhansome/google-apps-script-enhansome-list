...
* [googleworkspace/apps-script-samples](https://github.com/googleworkspace/apps-script-samples) ⭐ 5,232 | 🐛 123 | 🌐 JavaScript | 📅 2026-07-30 Various sample code and projects for the Google Apps Script platform
...
* [ashtonfei/google-apps-script-projects](https://github.com/ashtonfei/google-apps-script-projects) ⭐ 153 | 🐛 1 | 🌐 HTML | 📅 2025-01-18 A collection of Google Apps Script projects shared on YouTube
...
* [google/clasp](https://github.com/google/clasp) ⭐ 5,782 | 🐛 53 | 🌐 TypeScript | 📅 2026-06-08 Develop Apps Script projects locally using clasp (Command Line Apps Script Projects) CLI
* [gas-github](https://github.com/leonhartX/gas-github) ⭐ 4,436 | 🐛 51 | 🌐 JavaScript | 📅 2025-03-12 Chrome-extension to manage Google Apps Script(GAS) code with github/github enterprise
...
* [ggsrun](https://github.com/tanaikech/ggsrun) ⭐ 171 | 🐛 0 | 🌐 Go | 📅 2026-07-20 This is a CLI tool to execute Google Apps Script (GAS) on a terminal
...
* [brucemcpherson/gas-fakes](https://github.com/brucemcpherson/gas-fakes) ⭐ 78 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-12 A proof of concept implementation of Apps Script environment on node.js
* [rudimusmaximus/DevFlow](https://github.com/rudimusmaximus/DevFlow) ⭐ 53 | 🐛 60 | 🌐 JavaScript | 📅 2018-09-13 A Dev Flow for Google Apps Script
...
* [Google Apps Script Library Database](https://github.com/tanaikech/Google-Apps-Script-Library-Database) ⭐ 141 | 🐛 0 | 🌐 HTML | 📅 2026-05-18 Directory with more than 200 libraries
...
* [apps-script-oauth2](https://github.com/gsuitedevs/apps-script-oauth2) ⭐ 1,743 | 🐛 45 | 🌐 JavaScript | 📅 2026-06-16 An OAuth2 library for Google Apps Script
...
* [Gmail2GDrive](https://github.com/ahochsteger/gmail-processor/tree/1.x) ⭐ 587 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-15  Automatically stores and sorts Gmail attachments into Google Drive folders - replaced by [Gmail Processor](https://ahochsteger.github.io/gmail-processor/)
...
* [googlesamples/apps-script](https://github.com/googlesamples/apps-script) ⭐ 5,232 | 🐛 123 | 🌐 JavaScript | 📅 2026-07-30 Sample code for Google Apps Script, a cloud-based scripting service for Google Apps
* [An Example of using an HTML form (e.g: "Contact Us" on a website) to send Email without a Backend Server (using a Google Script)](https://github.com/dwyl/html-form-send-email-via-google-script-without-server) ⭐ 3,213 | 🐛 26 | 🌐 HTML | 📅 2024-08-04
...
* [BkperApp](https://github.com/bkper/bkper-app) ⭐ 11 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-14 A simple and secure way to access the Bkper API through Google Apps Script infrastructure

# Awesome Google Apps Script List with stars
...
* [googleworkspace/apps-script-samples](https://github.com/googleworkspace/apps-script-samples) ⭐ 5,238 | 🐛 121 | 🌐 JavaScript | 📅 2026-07-30 Various sample code and projects for the Google Apps Script platform
...
* [ashtonfei/google-apps-script-projects](https://github.com/ashtonfei/google-apps-script-projects) ⭐ 151 | 🐛 1 | 🌐 HTML | 📅 2025-01-18 A collection of Google Apps Script projects shared on YouTube
...
* [google/clasp](https://github.com/google/clasp) ⭐ 5,803 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-21 Develop Apps Script projects locally using clasp (Command Line Apps Script Projects) CLI
* [gas-github](https://github.com/leonhartX/gas-github) ⭐ 4,468 | 🐛 51 | 🌐 JavaScript | 📅 2025-03-12 Chrome-extension to manage Google Apps Script(GAS) code with github/github enterprise
...
* [brucemcpherson/gas-fakes](https://github.com/brucemcpherson/gas-fakes) ⭐ 79 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-12 A proof of concept implementation of Apps Script environment on node.js
* [rudimusmaximus/DevFlow](https://github.com/rudimusmaximus/DevFlow) ⭐ 54 | 🐛 60 | 🌐 JavaScript | 📅 2018-09-13 A Dev Flow for Google Apps Script
* [selectnull/eslint-plugin-googleappsscript](https://github.com/selectnull/eslint-plugin-googleappsscript) ⭐ 52 | 🐛 4 | 🌐 JavaScript | 📅 2024-07-03 ESLint plugin for Google Apps Script environment
...
* [enuchi/React-Google-Apps-Script](https://github.com/enuchi/React-Google-Apps-Script) ⭐ 1,527 | 🐛 32 | 🌐 JavaScript | 📅 2026-02-14 This is your boilerplate project for developing React apps inside Google Sheets, Docs, Forms and Slides projects. It's perfect for personal projects and for publishing complex add-ons in the G Suite Marketplace.
* [apps-script-starter](https://github.com/labnol/apps-script-starter) ⭐ 1,250 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-14 A starter kit for building Google Apps Script projects with modern JavaScript ES6, Webpack, Babel and ESLint inside Visual Studio Code
...
* [ez-clasp](https://github.com/cristobalgvera/ez-clasp) ⭐ 35 | 🐛 0 | 🌐 TypeScript | 📅 2025-10-08 A starter kit for building Google Apps Script projects with TypeScript, ESLint, Prettier, Jest and Rollup support out of the box.
* [gas-shell](https://github.com/JeanRemiDelteil/gas-shell) ⭐ 31 | 🐛 0 | 🌐 JavaScript | 📅 2020-10-16 Starter template to develop locally Google AppsScript project with your preferred code editor (include build and publish as Add-on commands)
...
* [artnc/gas-es6-webpack](https://github.com/artnc/gas-es6-webpack) ⭐ 22 | 🐛 1 | 🌐 JavaScript | 📅 2017-04-03 ES6+Webpack boilerplate for Google Apps Script
...
* [realworld-apps-script](https://github.com/lastlink/realworld-apps-script) ⭐ 14 | 🐛 20 | 🌐 JavaScript | 📅 2023-01-05 JWT REST API following the RealWorld API spec
* [faresd/google-apps-script\_travis-ci](https://github.com/faresd/google-apps-script_travis-ci) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2018-02-26 Automating Apps Script build, test, deployment and publishing in Chrome Webstore as an add-on using Travis CI
* [sao-clasp](https://github.com/takanakahiko/sao-clasp) ⚠️ Archived With one command, Generate a Google Apps Script project that uses clasp
* [zaki-yama/webpack-google-apps-script-template](https://github.com/zaki-yama/webpack-google-apps-script-template) ⚠️ Archived Template for developing Google Apps Script with Webpack
* [google-app-script-ts-jest](https://github.com/lastlink/google-app-script-ts-jest) ⭐ 8 | 🐛 18 | 🌐 JavaScript | 📅 2023-01-05 Rest api in typescript with jest unit tests working with vscode debugger
* [gazf/google-apps-script-ci-starter](https://github.com/gazf/google-apps-script-ci-starter) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2018-09-11 Google Apps Script with CI/CD(wercker) Starter Kit
...
* [FirebaseApp](https://github.com/RomainVialard/FirebaseApp) ⭐ 121 | 🐛 6 | 🌐 JavaScript | 📅 2021-02-01 The Google Apps Script binding for the Firebase Realtime Database
* [oshliaer/alasqlgs](https://github.com/oshliaer/alasqlgs) ⭐ 39 | 🐛 11 | 🌐 JavaScript | 📅 2023-03-04 AlaSQLGS is a library that enables the use of the AlaSQL.js library in Google Apps Script
* [p3sn/FireScript](https://github.com/p3sn/FireScript) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2018-09-18 Google Apps Script library for Firebase Admin, looking a lot like the NodeJS Admin SDK

### ORM (O/RM and O/R mapping tool)

* [Sheetfu](https://github.com/socialpoint-labs/sheetfu) ⭐ 849 | 🐛 7 | 🌐 Python | 📅 2022-03-16 An ORM to treat spreadsheet as database tables using Google Apps Scripts. [Sheetfu's Python version](https://github.com/socialpoint-labs/sheetfu) ⭐ 849 | 🐛 7 | 🌐 Python | 📅 2022-03-16
...
* [GoogleScriptSQL](https://github.com/YionoFr/GoogleScriptSQL) ⭐ 47 | 🐛 2 | 🌐 JavaScript | 📅 2019-12-27 How to transform Google Sheet and Google App script into a SQL Database
...
* [lodashgs](https://github.com/oshliaer/lodashgs) ⭐ 164 | 🐛 4 | 🌐 JavaScript | 📅 2023-04-18 Lodash for Google Apps Script is a library that enables the use of the lodash.js library in Google Apps Script
* [Gexpress](https://github.com/coderofsalvation/Gexpress) ⭐ 79 | 🐛 0 | 📅 2020-05-29 Express-ish middleware for google appscript (build NODEJS-ish applications)
* [brucemcpherson/cUseful](https://github.com/brucemcpherson/cUseful) ⭐ 71 | 🐛 0 | 🌐 JavaScript | 📅 2024-08-30 Various dependency free useful functions
* [gas-underscore](https://github.com/simula-innovation/gas-underscore) ⭐ 60 | 🐛 0 | 🌐 CoffeeScript | 📅 2021-06-25 Underscore for Google Apps Script
* [EnhancedCacheService](https://github.com/yinonavraham/GoogleAppsScripts/tree/master/EnhancedCacheService) ⭐ 55 | 🐛 0 | 🌐 JavaScript | 📅 2021-12-01 A cache service which wraps the GAS's native Cache to provide additional features
* [XmlRpcMessageService](https://github.com/yinonavraham/GoogleAppsScripts/tree/master/XmlRpcMessageService) ⭐ 55 | 🐛 0 | 🌐 JavaScript | 📅 2021-12-01 A service for simplifying the usage of XML-RPC services from JavaScript in Google Apps Script
* [GmailSearchBuilder](https://github.com/yinonavraham/GoogleAppsScripts/tree/master/GmailSearchBuilder) ⭐ 55 | 🐛 0 | 🌐 JavaScript | 📅 2021-12-01 A builder service for Gmail search queries. It provides a fluent API (chaining methods) for building a search query for mail threads in Gmail
...
* [UrlShortener](https://github.com/mhawksey/UrlShortener) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2021-02-21 A replacement for the Google Apps Script UrlShortener advanced service that uses bit.ly
* [syslogic/google-apps-script](https://github.com/syslogic/google-apps-script) ⭐ 12 | 🐛 0 | 🌐 JavaScript | 📅 2021-08-24 CloudDatastore.gs is a client for Google Cloud Datastore, which runs as a Service Account
* [michalliu/google-app-script-jsonrpc](https://github.com/michalliu/google-app-script-jsonrpc) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2013-09-18 An implementation of JSON-RPC 2.0 specification
* [classroomtechtools/ObjectStore](https://github.com/classroomtechtools/ObjectStore) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2021-07-15 A store for appscripts that utilizes Properties, Cache, and an in-memory map for speed
...
* [scriptit-fr/GenAIApp](https://github.com/scriptit-fr/GenAIApp) ⭐ 28 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-27 Google Apps Script binding for Gemini and OpenAI generative AI APIs

### Parsing

* [cheeriogs](https://github.com/tani/cheeriogs) ⭐ 494 | 🐛 6 | 🌐 JavaScript | 📅 2024-08-17 HTML manipulation library with jQuery-like interface
* [Apps-Script-htmlparser2-library](https://github.com/Spencer-Easton/Apps-Script-htmlparser2-library) ⭐ 30 | 🐛 3 | 🌐 JavaScript | 📅 2017-06-05 A browserified version of fb55/htmlparser2 modified to work in Google Apps Script
* [PdfApp](https://github.com/tani/pdf.gs) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2024-08-07 PdfApp is a library to extract text content from a PDF file using PDF.js.

### oAuth

* [apps-script-oauth2](https://github.com/gsuitedevs/apps-script-oauth2) ⭐ 1,744 | 🐛 46 | 🌐 JavaScript | 📅 2026-06-16 An OAuth2 library for Google Apps Script
...
* [googledatastudio/community-connectors](https://github.com/googledatastudio/community-connectors) ⚠️ Archived This repository contains open source content for Google Data Studio

### Pack modules and universal libraries

* [classroomtechtools/modularLibraries](https://github.com/classroomtechtools/modularLibraries.gs) ⭐ 49 | 🐛 1 | 🌐 JavaScript | 📅 2020-02-06 A collection of importable, modular libraries for any GAS project
...
* [Code Blocks](https://github.com/alexwforsythe/code-blocks) ⭐ 788 | 🐛 95 | 🌐 JavaScript | 📅 2026-07-25 Syntax highlighting for Google Docs
...
* [mithunmanohar/woocommerce-orders-google-sheets-integration](https://github.com/mithunmanohar/woocommerce-orders-google-sheets-integration) ⭐ 117 | 🐛 32 | 🌐 JavaScript | 📅 2021-06-07 Connect and sync order data from your WooCommerce store to Google sheets automatically. A free alternative to Zapier-WooCommerce integration that saves new WooCommerce order details to google sheets. Version V2 with improved features is now available
...
* [Google Forms](https://github.com/labnol/google-forms) ⭐ 91 | 🐛 0 | 🌐 JavaScript | 📅 2018-12-25 Google Scripts for sending emails, generating PDFs and setting response limits inside Google Forms.
* [email-studio-gmail-addon](https://github.com/labnol/email-studio-gmail-addon) ⭐ 85 | 🐛 0 | 🌐 JavaScript | 📅 2020-04-23 Gmail add-on for Mail Merge and Email Scheduler
* [sajacy/google-sheets-what-if-analysis](https://github.com/sajacy/google-sheets-what-if-analysis) ⭐ 53 | 🐛 26 | 🌐 JavaScript | 📅 2020-05-17 Replicates the Excel "What-If Analysis" feature, Data Tables
* [erickoledadevrel/crop-sheet](https://github.com/erickoledadevrel/crop-sheet) ⭐ 47 | 🐛 0 | 🌐 JavaScript | 📅 2022-06-30 An add-on for Google Sheets that allows you to easily remove extra rows and columns
* [ericyd/gdrive-transfer](https://github.com/ericyd/gdrive-transfer) ⚠️ Archived Web app to transfer ownership of a Google Drive folder, including all sub-folders and documents
* [Flubaroo](https://github.com/edcodeorg/flubaroo) ⭐ 27 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-18 Add-on for Google Spreadsheets that allows teachers to quickly grade assignments, get insights into student performance, and share grades with their students electronically
* [gauravgrover95/woocommerce-smartsheets](https://github.com/gauravgrover95/woocommerce-smartsheets) ⭐ 19 | 🐛 4 | 🌐 JavaScript | 📅 2016-06-18 Google Spreadsheets add on to import your WooCommerce supported E-Commerce website data to Google Sheets
* [stardotbmp/slack-gas-signup](https://github.com/stardotbmp/slack-gas-signup) ⭐ 16 | 🐛 0 | 🌐 HTML | 📅 2017-10-05 Google Apps Script Html Webapp as sign-up page for a slack channel
* [zmandel/timeline-jira-google-sheets](https://github.com/zmandel/timeline-jira-google-sheets) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2024-06-18 Create Jira timelines for multiple projects in Google Sheets
...
* [Viber/build-a-bot-with-zero-coding](https://github.com/Viber/build-a-bot-with-zero-coding) ⭐ 486 | 🐛 14 | 🌐 JavaScript | 📅 2022-03-21 An example of using Google Sheets to create a Viber survey chat bot without a backend server
* [Guf-Hub/TGBot](https://github.com/Guf-Hub/TGBot) ⭐ 51 | 🐛 4 | 🌐 JavaScript | 📅 2025-03-27 Google Apps Script library for working with the Telegram API. Google Apps Script библиотека для работы с API Telegram
* [Facebook-bot-Google-Apps-Script](https://github.com/JZL/Facebook-bot-Google-Apps-Script) ⭐ 46 | 🐛 0 | 🌐 JavaScript | 📅 2016-07-02 A Facebook messenger bot implemented in Google Apps Script
* [GroupMe Bots with Google Apps Script](https://github.com/william-reed/GroupMe-Bots-With-Google-Apps-Script) ⭐ 41 | 🐛 1 | 🌐 JavaScript | 📅 2020-03-22 Examples and resources for using the GroupMe Bot API with Google Apps Script
* [banghasan/Telegram-Lib-GAS-V2](https://github.com/banghasan/Telegram-Lib-GAS-V2) ⭐ 24 | 🐛 0 | 🌐 JavaScript | 📅 2021-06-19 Library Telegram untuk Google Apps Script Versi 2
* [Google-Telegram transfer bot](https://github.com/cyberonion256/google-telegram_transferbot) ⭐ 15 | 🐛 0 | 📅 2020-04-17 This Google Apps Script links a Telegram bot to a google spreadsheet and allows command-based information storaging
* [Google Apps Script Sheet MQ](https://github.com/scrthq/GoogleAppsScriptSheetMQ) ⭐ 14 | 🐛 1 | 🌐 JavaScript | 📅 2019-03-19 Google Apps Script endpoint for Hangouts Chat bot using Sheets as a message queue

[goto top ⇑](#google-apps-script-list)

## Testing

* [huan/gast](https://github.com/huan/gast) ⭐ 113 | 🐛 8 | 🌐 JavaScript | 📅 2021-04-11 Google Apps Script TAP Testing-framework
* [simula-innovation/qunit](https://github.com/simula-innovation/qunit) ⭐ 65 | 🐛 4 | 🌐 JavaScript | 📅 2015-10-21 An easy-to-use JavaScript Unit Testing framework
* [classroomtechtools/modularLibraries.gs/UnitTesting](https://github.com/classroomtechtools/modularLibraries.gs/tree/master/UnitTesting) ⭐ 49 | 🐛 1 | 🌐 JavaScript | 📅 2020-02-06 Assertion and unit testing of modular libraries
* [WildH0g/UnitTestingApp](https://github.com/WildH0g/UnitTestingApp) ⭐ 39 | 🐛 1 | 🌐 JavaScript | 📅 2021-10-31 Unit Testing App for Google Apps Script that works online (in GAS environment) and offline (in your IDE).
* [artofthesmart/QUnitGS2](https://github.com/artofthesmart/QUnitGS2) ⭐ 28 | 🐛 9 | 🌐 JavaScript | 📅 2020-08-01 A Google Apps Script library that brings the power and simplicity of QUnit unit testing to your scripts and applications. In just 60 seconds you can add unit testing to any script.
* [gasunit/GASUnit](https://github.com/gasunit/GASUnit) ⚠️ Archived Testing library for Google Apps Script
...
* [BetterLog](https://github.com/peterherrmann/BetterLog) ⭐ 239 | 🐛 2 | 🌐 JavaScript | 📅 2021-12-09 Logging library that extends the native apps script Logger, mainly to allow logging to a GSheet
* [BBLog](https://github.com/andrewroberts/BBLog) ⭐ 36 | 🐛 3 | 🌐 JavaScript | 📅 2023-12-20 Logging library that further extends BLog to give logging to a Firebase DB multiple logging instances logging of function names and line numbers log the user's email address or ID, in a full or disguised format automatically format log GSheet
* [huan/gasl](https://github.com/huan/gasl) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2020-12-16 Google Apps Script Logging-framework
...
* [Collection of Apps Scripts for connecting to APIs](https://github.com/benlcollins/apps_script_apis) ⭐ 194 | 🐛 2 | 🌐 JavaScript | 📅 2022-07-28
* [Google Apps Script snippets ᕦʕ •ᴥ•ʔᕤ](https://apps-script-snippets.contributor.pw/)

#### Spreadsheets

* [ReshapeReshaping functions for Google Spreadsheets](https://github.com/rgertenbach/Reshape) ⭐ 25 | 🐛 2 | 🌐 JavaScript | 📅 2019-05-31
...
* [Gmail2GDrive](https://github.com/ahochsteger/gmail-processor/tree/1.x) ⭐ 586 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-27  Automatically stores and sorts Gmail attachments into Google Drive folders - replaced by [Gmail Processor](https://ahochsteger.github.io/gmail-processor/)
...
* [googlesamples/apps-script](https://github.com/googlesamples/apps-script) ⭐ 5,238 | 🐛 121 | 🌐 JavaScript | 📅 2026-07-30 Sample code for Google Apps Script, a cloud-based scripting service for Google Apps

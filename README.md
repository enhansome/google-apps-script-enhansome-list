...
* [google/clasp](https://github.com/google/clasp) ⭐ 5,835 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-28 Develop Apps Script projects locally using clasp (Command Line Apps Script Projects) CLI
* [gas-github](https://github.com/leonhartX/gas-github) ⭐ 4,521 | 🐛 51 | 🌐 JavaScript | 📅 2025-03-12 Chrome-extension to manage Google Apps Script(GAS) code with github/github enterprise
...
* [appsscript-utils](https://github.com/MaksymStoianov/appsscript-utils) ⭐ 29 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-13 A collection of reusable utilities and helpers for Google Apps Script development, written in TypeScript
...
* [Gmail2GDrive](https://github.com/ahochsteger/gmail-processor/tree/1.x) ⭐ 587 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-18  Automatically stores and sorts Gmail attachments into Google Drive folders - replaced by [Gmail Processor](https://ahochsteger.github.io/gmail-processor/)
